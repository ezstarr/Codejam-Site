      ...
      <div className={styles.container}>
        ...
        <div className={styles.innerContainer}>
          ...
          <nav className={styles.navContainer}>
            ...
            <button
              className={`${styles.navButton} ${
                page === "timeline" ? styles.navActive : ""
              }`}
          ...
          <div className={styles.contentContainer}>
            ...
            <div className={page === "goal" ? styles.contentDiv : styles.hide}>
              <div className={styles.innerContentDiv}>
                ...
                <p>
                  ...
                  something engaging to share with others, ideally with others,
                  and… to make it as fun as possible. 😀 It’s an opportunity to
                  exercise skills in collaboration, creativity, and learning.
                  How does it feel to work in a team? I don’t know - let’s find
                  out!{" "}
                </p>
                ...
                <p>
                  ...
                  ? If one person improves as a developer, or if a new
                  friendship is made, we would be so happy and consider this
                  event a success. As a bonus, maybe we can add a new project to
                  our resume and gain a new network that lasts beyond this
                  event. :)
                </p>
                <br />
                ...
                <p>
                  ...
                  community was created on Twitch, we thought it'd be
                  appropriate if the CodeJam revolved around Twitch related
                  software! Don't get started yet, you still need the{" "}
                ...
                <p>
                  The options are really endless when it comes to Twitch
                ...
                <UlC>
                  ...
                  <li>Website</li>
                  <li>
                    So on and so forth, as long as we can tell it's something
                    that has to do with Twitch. :)
                  </li>
                </UlC>
                <h2>
                ...
                <p>
                  ...
                  <a href={"https://discord.gg/timeenjoyed"}>
                    TimeEnjoyed's Discord
                  </a>{" "}
                  and registered in the codejam to be notified of all related
                  updates ^^
                </p>
              </div>
            </div>
            ...
            <div
              className={page === "timeline" ? styles.contentDiv : styles.hide}
            >
              <div className={styles.innerContentDiv}>
                <h1>Timeline</h1>
                <div>
                ...
                <div>
                  ...
                  <UlC>
                    ...
                    <li>
                      You'll get a Repository for your team in our Github.
                    </li>
                  </UlC>
                </div>
                ...
                <div>
                  ...
                  <UlC>
                    <li>
                      Competition Ends - we collect submissions before midnight
                      UTC
                    </li>
                  </UlC>
                </div>
                ...
                <div>
                  ...
                  <UlC>
                    ...
                    <UlC>
                      <li>
                        Each vote is going to cost 300 channel points, so please
                        save up!
                      </li>
                    </UlC>
                  </UlC>
            ...
            <div className={page === "rules" ? styles.contentDiv : styles.hide}>
              <div className={styles.innerContentDiv}>
                ...
                <UlC>
                  <li>
                    We'll provide a Repository for your team. (tracks commits,
                    etc)
                  </li>
                  <li>
                ...
                <UlC>
                  ...
                  <li>
                    No tokens/keys that can’t be made for free by ourselves.
                  </li>
                  <UlC>
                    <li>
                      Example: If making a twitch bot, we should be able to put
                      in our own bot token.
                    </li>
                  </UlC>
                ...
                <UlC>
                  <li>
                    If code requires high end gpu or we can’t run it, pls make a
                    video demo for us to play.
                  </li>
                  <li>
                    If addt'l software is used, need very clear instructions.
                  </li>
                </UlC>
              </div>
            </div>
            ...
            <div
              className={page === "prizes" ? styles.contentDiv : styles.hide}
            >
              <div className={styles.innerContentDiv}>
                <h1>Prizes</h1>
                <p>
                  Everyone who participates will get a hoisted discord badge!
                  Everyone also will get CodeJam 2023 stickers, as long as they
                  provide a shipping address and the cost isn't over 10USD. We
                  are still brainstorming other prizes that are digital or
                  otherwise.
                </p>
              </div>
            </div>
            ...
            <div
              className={
                page === "participants" ? styles.contentDiv : styles.hide
              }
            >
              <div className={styles.innerContentDiv}>
                <h1>Participants</h1>
            ...
            <div
              className={page === "credits" ? styles.contentDiv : styles.hide}
            >
              <div className={styles.innerContentDiv}>
                <h1>Credits</h1>
                <p>
                  First off, thanks Mysty for making this whole thing happen.
                  Thanks to everyone who volunteered to test and contribute
                  ideas. More credits will be given as the codejam continues.
                </p>
              </div>
            </div>

            <div
              className={page === "copyleft" ? styles.contentDiv : styles.hide}
            >
              <div className={styles.innerContentDiv}>
                <h1>Copyleft License</h1>
                <a href="#" onClick={() => setPage("rules")}>
                  Return
                </a>
                <p>
                ...
                <p>
                  I asked ChatGPT: "can you explain what a copy left license
                  does in simple terms, especially when it comes to using it in
                  a code jam"
                </p>
                <p>It replied:</p>
                <UlC>
                  ...
                  <li>
                    When you use a copyleft license in a code jam, it means that
                    any code you contribute or modify during the jam must also
                    be made available under the same copyleft license. This
                    requirement ensures that the code and its derivatives stay
                    open-source and freely available to others.
                  </li>
                  <li>
                    Let's say you participate in a code jam and use a copyleft
                    license for your code. If someone else wants to use or
                    modify your code, they are also required to make their
                    changes available under the same copyleft license. This
                    ensures that the software community continues to benefit
                    from the contributions and encourages collaboration and
                    sharing of code.
                  </li>
                  <li>
                    Copyleft licenses are often used in code jams and
                    open-source projects to foster a culture of collaboration,
                    sharing, and innovation. They help ensure that the code
                    remains freely accessible, encourages others to contribute
                    improvements, and prevents the code from being turned into
